...
export const getModelCurve = (name) => {
  ...
  switch(name){
    ...
    case 'mandibular': model = MANDIBULAR;
      break;
    case 'mandibular 4': model = MANDIBULAR4;
      break;
  ...
  controlPoints: [
    {
      ...
      controlPoint1: {
        name: 'R3_TO_sCo_P1',
        positionDefault: (markerPoints) => {
          const controlPoint = markerPoints['R3_TO_sCo_P1'];
          const startPoint = markerPoints['R3'];
          const endPoint = markerPoints['sCo'];

          return controlPoint? controlPoint : {
            x: startPoint.x - point2PointDistance(startPoint,endPoint)/1.8,
            y: startPoint.y - point2PointDistance(startPoint,endPoint)/6
          }
        }
      },
      controlPoint2: {
        name: 'R3_TO_sCo_P2',
        positionDefault: (markerPoints) => {
          const controlPoint = markerPoints['R3_TO_sCo_P2'];
          const startPoint = markerPoints['R3'];
          const endPoint = markerPoints['sCo'];

          return controlPoint? controlPoint : {
            x: endPoint.x + point2PointDistance(startPoint,endPoint)/3,
            y: endPoint.y + point2PointDistance(startPoint,endPoint)/20
          }
        }
      } 
    },
    {
      ...
      controlPoint1: {
        name: 'sCo_TO_Co_P1',
        positionDefault: (markerPoints) => {
          const controlPoint = markerPoints['sCo_TO_Co_P1'];
          const startPoint = markerPoints['sCo'];
          const endPoint = markerPoints['Co'];
      ...
      controlPoint2: {
        name: 'sCo_TO_Co_P2',
        positionDefault: (markerPoints) => {
          const controlPoint = markerPoints['sCo_TO_Co_P2'];
          const startPoint = markerPoints['sCo'];
          const endPoint = markerPoints['Co'];
    ...
    },
    {
      ...
      controlPoint1: {
        name: 'Co_TO_Pcc_P1',
        positionDefault: (markerPoints) => {
          const controlPoint = markerPoints['Co_TO_Pcc_P1'];
          const startPoint = markerPoints['Co'];
          const endPoint = markerPoints['Pcc'];
      ...
      controlPoint2: {
        name: 'Co_TO_Pcc_P2',
        positionDefault: (markerPoints) => {
          const controlPoint = markerPoints['Co_TO_Pcc_P2'];
          const startPoint = markerPoints['Co'];
          const endPoint = markerPoints['Pcc'];
    ...
    },
    {
      ...
      controlPoint1: {
        name: 'Pcc_TO_Ar_P1',
        positionDefault: (markerPoints) => {
          const controlPoint = markerPoints['Pcc_TO_Ar_P1'];
          const startPoint = markerPoints['Pcc'];
          const endPoint = markerPoints['Ar'];

          return controlPoint? controlPoint : {
            x: startPoint.x + point2PointDistance(startPoint,endPoint)/9,
            y: startPoint.y + point2PointDistance(startPoint,endPoint)/2
          }
        }
      },
      controlPoint2: {
        name: 'Pcc_TO_Ar_P2',
        positionDefault: (markerPoints) => {
          const controlPoint = markerPoints['Pcc_TO_Ar_P2'];
          const startPoint = markerPoints['Pcc'];
          const endPoint = markerPoints['Ar'];
    ...
    },
    {
      ...
      controlPoint1: {
        name: 'Ar_TO_Sg_P1',
        positionDefault: (markerPoints) => {
          const controlPoint = markerPoints['Ar_TO_Sg_P1'];
          const startPoint = markerPoints['Ar'];
          const endPoint = markerPoints['Sg'];
      ...
      controlPoint2: {
        name: 'Ar_TO_Sg_P2',
        positionDefault: (markerPoints) => {
          const controlPoint = markerPoints['Ar_TO_Sg_P2'];
          const startPoint = markerPoints['Ar'];
          const endPoint = markerPoints['Sg'];

          return controlPoint? controlPoint : {
            x: endPoint.x - point2PointDistance(startPoint,endPoint)/22,
            y: endPoint.y - point2PointDistance(startPoint,endPoint)/3.3
          }
        }
      } 
    },
    {
      ...
      controlPoint1: {
        name: 'Sg_TO_Go_P1',
        positionDefault: (markerPoints) => {
          const controlPoint = markerPoints['Sg_TO_Go_P1'];
          const startPoint = markerPoints['Sg'];
          const endPoint = markerPoints['Go'];

          return controlPoint? controlPoint : {
            x: startPoint.x + point2PointDistance(startPoint,endPoint)/12,
            y: startPoint.y + point2PointDistance(startPoint,endPoint)/1.8
          }
        }
      },
      controlPoint2: {
        name: 'Sg_TO_Go_P2',
        positionDefault: (markerPoints) => {
          const controlPoint = markerPoints['Sg_TO_Go_P2'];
          const startPoint = markerPoints['Sg'];
          const endPoint = markerPoints['Go'];
    ...
    },
    {
      ...
      controlPoint1: {
        name: 'Go_TO_mGo_P1',
        positionDefault: (markerPoints) => {
          const controlPoint = markerPoints['Go_TO_mGo_P1'];
          const startPoint = markerPoints['Go'];
          const endPoint = markerPoints['mGo'];

          return controlPoint? controlPoint : {
            x: startPoint.x + point2PointDistance(startPoint,endPoint)/12,
            y: startPoint.y + point2PointDistance(startPoint,endPoint)/12
          }
        }
      },
      controlPoint2: {
        name: 'Go_TO_mGo_P2',
        positionDefault: (markerPoints) => {
          const controlPoint = markerPoints['Go_TO_mGo_P2'];
          const startPoint = markerPoints['Go'];
          const endPoint = markerPoints['mGo'];

          return controlPoint? controlPoint : {
            x: endPoint.x - point2PointDistance(startPoint,endPoint)/2,
            y: endPoint.y + point2PointDistance(startPoint,endPoint)/12
          }
        }
      } 
    },
    {
      ...
      controlPoint1: {
        ...
        hide: true,
        positionDefault: (markerPoints) => {
          const controlPoint = markerPoints['mGo_TO_R3_P1'];
      ...
      controlPoint2: {
        ...
        hide: true,
        positionDefault: (markerPoints) => {
          const controlPoint = markerPoints['mGo_TO_R3_P2'];
          const startPoint = markerPoints['mGo'];
          const endPoint = markerPoints['R3'];
