...
export default function IntraoralImages(props){
  ...
  const getListImage = () => {
    return new Promise((resolve, reject) => {
      ...
      getToServerWithToken(`/v1/libraryImagePatient/${props.patient.currentPatient.id}?typeImages=intraoral&mode=${props.checkRoleMode}&idDoctor=${doctor.data?.id}`).then(result => {
