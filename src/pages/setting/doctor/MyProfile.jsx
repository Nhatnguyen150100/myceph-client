    ...
    <div className="d-flex flex-row flex-grow-1">
      ...
      <div className="d-flex flex-column flex-grow-1 ms-5">
        ...
        <div className={`d-flex mb-3 ${editMode?'border-bottom':''}`}>
          ...
          <span className="text-capitalize mc-color fw-bold ms-2" style={{fontSize:props.FONT_SIZE,width:WIDTH_HEAD}}>{t('clinics')}:</span>
          <div className="d-flex flex-wrap flex-grow-1" style={{width:WIDTH_CHILD}}>
          {
            clinic?.map(clinic => {
              return <span className="px-2 hoverGreenLight rounded mc-background text-white text-capitalize shadow me-3 mb-1" style={{fontSize:props.FONT_SIZE,cursor:"pointer"}} onClick={e=>onToClinic(clinic.id,clinic.roleOfDoctor)}>
                {
